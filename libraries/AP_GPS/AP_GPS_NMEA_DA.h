...
/// NMEA parser
///
class AP_GPS_NMEA_DA : public AP_GPS_Backend
{
...
public:
	...
	static bool _detect(struct NMEA_DA_detect_state &state, uint8_t data);

    const char *name() const override { return "NMEA_DA"; }
...
private:
    ...
    AP_GPS::GPS_Head_Status _status;
...
#define AP_GPS_NMEA_DUAL_ANTENNA_INIT_STRING \
        "zhd com com1 57600\r\n" \
        "unlogall com1\r\n"          \
